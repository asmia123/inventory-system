...
import "../main.css";
import { ProductsURL, BrandsURL} from "../../../config/url-constant"
...
const validate = Yup.object().shape({
  ...
  summary: Yup.string().min(3, "Too Short!")
  .max(50, "Too Long!").required("Summary is required"),
  content: Yup.string().min(3, "Too Short!")
  .max(50, "Too Long!").required("Content is required"),
  product_id: Yup.array().required("Product is a required field"),
});
